    ...
    <>
      <footer className="footer">
        ...
        <ul className="footer-info">
          <li>
            <svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 0 24 24" width="40px" fill="#C3C3B4">
          ...
          <li>
            <svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" height="40px" viewBox="0 0 24 24" width="40px" fill="#C3C3B4">
              <g>
            ...
            <div>농협 699-02-02XX6X (예금주:송영선)</div>
          </li>
          <li>
            <svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 0 24 24" width="40px" fill="#C3C3B4">
              <path d="M0 0h24v24H0V0z" fill="none" />
